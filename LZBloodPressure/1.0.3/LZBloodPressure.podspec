...
#s.source_files = 'LZBloodPressure/**/*.m',
#s.public_header_files = 'LZBloodPressure/**/*.h'
...
# pod repo push leshiguang LZBloodPressure.podspec --allow-warnings --verbose
